...
public class TinThethaoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_tin_thethao, container, false);
        database = FirebaseDatabase.getInstance();
        reference = database.getReference("News");

        recyclerView = view.findViewById(R.id.rcv_tinthethao);
        ...
        reference.orderByChild("category").equalTo("thethao").addValueEventListener(new ValueEventListener()
        {
            @Override
